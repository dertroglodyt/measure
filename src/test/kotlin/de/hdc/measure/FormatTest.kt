...
internal class FormatTest {
  ...
  fun main() {
    ...
    assertEquals("2 300,000 Yg", Measure(2300000.0, ZETA, g).format())
    // Default values: 4 padding, 3 digits, auto-stepup overflow
    assertEquals("2 300,000 Yg", Measure(2300.0, YOTA, g).format())
    // Default values: 4 padding, 3 digits, auto-stepup overflow, padding overflow
    assertEquals("23 000,000 Yg", Measure(23000.0, YOTA, g).format())
