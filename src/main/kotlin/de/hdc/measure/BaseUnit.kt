...
object SI_GRAM : BaseUnit(Quantity(g = 1))
...
object SI_NEWTON : BaseUnit(Quantity(m = 1, g = 1, s = -2))
object SI_PASCAL : BaseUnit(Quantity(m = -1, g = 1, s = -2))
object SI_JOULE : BaseUnit(Quantity(m = 2, g = 1, s = -2))
object SI_WATT : BaseUnit(Quantity(m = 2, g = 1, s = -3))
object SI_VELOCITY : BaseUnit(Quantity(m = 1, g = 0, s = -1))
